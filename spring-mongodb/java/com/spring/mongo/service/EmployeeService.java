...
public class EmployeeService {
	...
	public long partialUpdate(Employee employee) {
		UpdateResult result=mongoTemplate.update(Employee.class).matching(Criteria.where("firstName").is("Rahul"))
		.apply(Update.update("salary", employee.getSalary()))
		.all();
	...
	public List<Employee> getEmployeeByExample(Employee employee){
