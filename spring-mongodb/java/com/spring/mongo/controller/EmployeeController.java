...
public class EmployeeController {
	...
	@PutMapping("/partial")
	public long partialUpdate(@RequestBody Employee employee) {
		return employeeService.partialUpdate(employee);
	}
	...
	@PostMapping("/example")
	public List<Employee> getEmployeeByExam(@RequestBody Employee employee){
